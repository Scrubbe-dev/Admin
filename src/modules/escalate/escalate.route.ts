...
import { TicketController } from "./escalet.controller";
import { validateEmail } from "./escalate.utils";

const escalateRouter = Router();
/**
 * @swagger
 * components:
 *   schemas:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
escalateRouter.post("/tickets/escalate/:ticketId", TicketController.escalateTicket);

export default escalateRouter;
