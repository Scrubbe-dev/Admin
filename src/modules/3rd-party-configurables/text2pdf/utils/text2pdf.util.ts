...
import { CompanyBranding, PdfTemplate } from '../text2pdf.types';

export class PdfUtil {
  /**
   * Generate unique filename for PDF
   */
  static generateFilename(id: string, template: string = 'standard'): string {
  ...
  static addCompanyHeader(
    ...
    doc.fontSize(9)
       .font('Helvetica')
       .fillColor('#7f8c8d')
       .text(`${address} | Tel: ${phone} | Email: ${email} | Web: ${website}`, 
             50, 85, { align: 'center' });
  }
  ...
  static addCompanyFooter(
    ...
    doc.fontSize(8)
       .font('Helvetica')
       .fillColor('#95a5a6')
       .text(`${branding.companyName} - Confidential Document`, 
             50, footerY, { align: 'left' })
       .text(`Page ${pageNumber} of ${totalPages}`, 
             50, footerY, { align: 'right' });
   ...
   */
  static getTemplate(templateName: string = 'standard'): PdfTemplate {
