...
import { TicketController } from "./intel.controller";
import router from "../escalate/escalate.route";
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
intelRouter.get("/tickets/intel/:ticketId", TicketController.getTicketIntel);

export default intelRouter;
