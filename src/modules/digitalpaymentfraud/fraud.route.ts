...
import {
  ...
  rateLimitMiddleware,
  authMiddleware
} from '../bec/bec.middleware';
import { logger } from '../../common/logger/logger';
import { fraudDetectionSchema } from './fraud.schema';
...
//   rateLimitMiddleware,
  //@ts-ignore
  async (req: Request, res: Response<FraudDetectionResponse | ErrorResponse>) => {
    try {
      // Validate request
      const validationResult = fraudDetectionSchema.safeParse(req.body);
      ...
      const request = validationResult.data as FraudDetectionRequest;
