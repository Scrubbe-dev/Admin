...
import { CustomerIncidentController } from "../controllers/customerIncidentController";
...
router.post(
  ...
  CustomerIncidentController.createIncident
);
...
router.get(
  ...
  CustomerIncidentController.getIncidents
);
...
router.get(
  ...
  CustomerIncidentController.getIncident
);
...
router.post(
  ...
  (req: Request, res: Response) => {
    CustomerIncidentController.addComment(req, res);
  }
);

export { router as customerIncidentRoutes };