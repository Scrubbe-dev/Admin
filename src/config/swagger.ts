...
apis: ["./src/modules/system/system.routes.ts","./src/modules/bec/bec.routes.ts","./src/modules/digitalpaymentfraud/fraud.route.ts","./src/modules/apikey/apikey.route.ts","./src/modules/auth/routes/auth.routes.ts", "./src/modules/business-profile/business.router.ts", "./src/modules/ezra-chat/ezra.route.ts"],
};
