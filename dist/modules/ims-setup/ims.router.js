...
const ims_controller_1 = require("./ims.controller");
const imsRouter = (0, express_1.Router)();
 ...
 */
imsRouter.post('/ims/setup', (req, res) => ims_controller_1.IMSController.setupIMS(req, res));
/**
 * @swagger
 * /api/v1/ims/health:
 *   get:
 ...
 */
imsRouter.get('/ims/health', ims_controller_1.IMSController.healthCheck);
exports.default = imsRouter;
