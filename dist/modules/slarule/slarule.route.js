...
const slarule_controller_1 = require("./slarule.controller");
// import { authenticate, authorize } from '../middleware/auth'; // Add auth middleware as needed
const slaRouter = (0, express_1.Router)();
const slaController = new slarule_controller_1.SLAController();
 ...
 *                   type: string
 */
slaRouter.post('/incidents/:id/sla/init', slaController.initializeSLA.bind(slaController));
slaRouter.get('/sla/check-breaches', slaController.checkSLABreaches.bind(slaController));
slaRouter.get('/incidents/:id/sla/status', slaController.getSLAStatus.bind(slaController));
exports.default = slaRouter;
