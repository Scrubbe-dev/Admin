 ...
 */
incidentRouter.get("/", authMiddleware.authenticate, 
// mustBeAMember,
(req, res, next) => {
 ...
 *         description: Failed to fetch incidents
 */
incidentRouter.get("/all", authMiddleware.authenticate, (req, res, next) => {
 ...
 */
incidentRouter.post("/", authMiddleware.authenticate, 
// mustBeAMember,
(req, res, next) => {
 ...
 */
incidentRouter.post("/comment/:incidentTicketId", authMiddleware.authenticate, 
// mustBeAMember,
(req, res, next) => {
 ...
 */
incidentRouter.get("/comment/:incidentTicketId", authMiddleware.authenticate, 
// mustBeAMember,
(req, res, next) => {
 ...
 *         description: Failed to create incident
 */
incidentRouter.put("/", authMiddleware.authenticate, 
// mustBeAMember,
(req, res, next) => {
 ...
 */
incidentRouter.get("/analytics", authMiddleware.authenticate, 
// mustBeAMember,
(req, res, next) => {
 ...
 */
incidentRouter.get("/message/:incidentTicketId", authMiddleware.authenticate, 
// mustBeAMember,
(req, res, next) => {
 ...
 */
incidentRouter.post("/acknowledge/:incidentTicketId", authMiddleware.authenticate, 
// mustBeAMember,
(req, res, next) => {
 ...
 */
incidentRouter.post("/resolve/:incidentTicketId", authMiddleware.authenticate, 
// mustBeAMember,
(req, res, next) => {
 ...
 */
incidentRouter.post("/resolve/customer-kb/:incidentTicketId", authMiddleware.authenticate, 
// mustBeAMember,
(req, res, next) => {
 ...
 */
incidentRouter.get("/resolve/ai/suggestion/:incidentTicketId", authMiddleware.authenticate, 
// mustBeAMember,
(req, res, next) => {
 ...
 */
incidentRouter.get("/resolve/ai/five-whys/:incidentTicketId", authMiddleware.authenticate, 
// mustBeAMember,
(req, res, next) => {
 ...
 */
incidentRouter.get("/resolve/ai/stakeholder/:incidentTicketId", authMiddleware.authenticate, 
// mustBeAMember,
(req, res, next) => {
 ...
 */
incidentRouter.get("/generate-id", authMiddleware.authenticate, (req, res, next) => {
