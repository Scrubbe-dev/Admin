 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
pricingRouter.post("/subscriptions", authMiddleware.authenticate, (req, res) => {
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
pricingRouter.put("/subscriptions", authMiddleware.authenticate, (req, res) => {
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
pricingRouter.post("/subscriptions/cancel", authMiddleware.authenticate, (req, res) => {
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
pricingRouter.get("/customers/:customerId/subscriptions", authMiddleware.authenticate, (req, res) => {
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
pricingRouter.post("/portal", authMiddleware.authenticate, (req, res) => {
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
pricingRouter.get("/customers/:customerId/invoices", authMiddleware.authenticate, (req, res) => {
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
pricingRouter.get("/customers/:customerId/payment-methods", authMiddleware.authenticate, (req, res) => {
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
pricingRouter.post("/webhook", (req, res) => {
 ...
 */
pricingRouter.post("/checkout/create-session", authMiddleware.authenticate, (req, res) => {
 ...
 *                   $ref: '#/components/schemas/Subscription'
 */
pricingRouter.get("/checkout/success", authMiddleware.authenticate, (req, res) => {
 ...
 */
pricingRouter.get("/checkout/session/:sessionId", authMiddleware.authenticate, async (req, res) => {
