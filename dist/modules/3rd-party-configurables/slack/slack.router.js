...
const slackController = new slack_controller_1.SlackController(slackService);
 ...
 */
slackRouter.get("/oauth/callback", authMiddleware.authenticate, (req, res, next) => {
 ...
 */
slackRouter.post("/default-channel", authMiddleware.authenticate, (req, res, next) => {
    slackController.submitDefaultChannel(req, res, next);
});
slackRouter.post("/commands", express_1.default.urlencoded({ extended: true }), (req, res, next) => slackController.handleSlashCommand(req, res, next));
