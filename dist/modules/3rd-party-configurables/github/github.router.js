...
const github_webhook_1 = require("./github.webhook");
const dotenv_1 = __importDefault(require("dotenv"));
dotenv_1.default.config();
const githubRouter = express_1.default.Router();
const tokenService = new token_service_1.TokenService(process.env.JWT_SECRET, process.env.JWT_EXPIRES_IN || "1h", 15 // 15 mins
);
const authMiddleware = new auth_middleware_1.AuthMiddleware(tokenService);
const githubWebhookService = new github_webhook_1.GithubWebhookService();
const githubService = new github_service_1.GithubService(githubWebhookService);
const githubController = new github_controller_1.GithubController(githubService);
/**
 * @swagger
...
/**
 * @swagger
 * /api/v1/integrations/github/callbacks/github:
 *   get:
...
githubRouter.get("/callbacks/github", authMiddleware.authenticate, (req, res, next) => {
...
//  */
githubRouter.post("/webhook", express_1.default.json(), (req, res, next) => {
