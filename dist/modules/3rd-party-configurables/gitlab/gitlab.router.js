...
const gitlabRouter = express_1.default.Router();
...
const gitlabService = new gitlab_service_1.GitlabService();
const gitlabController = new gitlab_controller_1.GitlabController(gitlabService);
/**
 * @swagger
 ...
 */
gitlabRouter.get("/connect", auth.authenticate, (req, res, next) => gitlabController.connectGitlab(req, res, next));
/**
 * @swagger
 ...
 */
gitlabRouter.get("/callback", (req, res, next) => gitlabController.handleOAuthCallback(req, res, next));
/**
 * @swagger
 ...
 *         description: Unauthorized (no valid token provided)
 */
gitlabRouter.get("/projects", auth.authenticate, (req, res, next) => gitlabController.listProjects(req, res, next));
/**
 * @swagger
 * /api/v1/integrations/gitlab/projects:
 *   post:
 ...
 *         description: Unauthorized (no valid token provided)
 */
gitlabRouter.post("/projects", auth.authenticate, (req, res, next) => gitlabController.saveMonitoredProjects(req, res, next));
// /**
//  * @swagger
...
//  */
gitlabRouter.post("/webhook", express_1.default.json({ type: "*/*" }), (req, res, next) => gitlabController.handleWebhook(req, res, next));
exports.default = gitlabRouter;
