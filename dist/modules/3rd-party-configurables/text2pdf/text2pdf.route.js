...
const text2pdf_controller_1 = require("./text2pdf.controller");
 ...
 *               $ref: '#/components/schemas/ValidationError'
 */
router.post('/generate-pdf', text2pdf_controller_1.PdfController.generatePdf);
/**
 * @swagger
 * /api/v1/preview:
 *   post:
 ...
 *               $ref: '#/components/schemas/ValidationError'
 */
router.post('/preview', text2pdf_controller_1.PdfController.previewPdf);
/**
 * @swagger
 * /api/v1/templates:
 *   get:
 ...
 *               $ref: '#/components/schemas/ValidationError'
 */
router.get('/templates', text2pdf_controller_1.PdfController.getTemplates);
/**
 * @swagger
 * /api/v1/download/{id}:
 *   get:
 ...
 *               $ref: '#/components/schemas/ValidationError'
 */
router.get('/download/:id', text2pdf_controller_1.PdfController.downloadById);
