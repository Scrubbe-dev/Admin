...
exports.incidentStakeholderMessage = exports.incidentFiveWhys = exports.recommendedAction = exports.determineRiskScore = void 0;
exports.rule = rule;
exports.interpretPrompt = interpretPrompt;
exports.summarizeIncidents = summarizeIncidents;
exports.visualGraph = visualGraph;
exports.rootCauseSuggestion = rootCauseSuggestion;
...
function interpretPrompt(userPrompt) {
    return `
...
function summarizeIncidents(data) {
    return `
...
INCIDENTS DATA (JSON):
${JSON.stringify(data.incidents?.map((incident, i) => ({
...
exports.determineRiskScore = determineRiskScore;
...
exports.incidentFiveWhys = incidentFiveWhys;
const incidentStakeholderMessage = () => {
...
exports.incidentStakeholderMessage = incidentStakeholderMessage;
