...
const ezra_controller_1 = require("./ezra.controller");
const auth_middleware_1 = require("../auth/middleware/auth.middleware");
const client_1 = require("@prisma/client");
const token_service_1 = require("../auth/services/token.service");
const ezra_service_1 = require("./ezra.service");
const ezraRouter = express_1.default.Router();
...
const ezraService = new ezra_service_1.EzraService(prismaClient);
const ezraController = new ezra_controller_1.EzraController(ezraService);
 ...
 */
ezraRouter.post("/incidents/summary", authMiddleware.authenticate, (req, res, next) => ezraController.summarizeIncidents(req, res, next));
/**
 * @swagger
 ...
 */
ezraRouter.post("/reset-chat", authMiddleware.authenticate, (req, res, next) => {
 ...
 */
ezraRouter.post("/incidents/visual_graph", authMiddleware.authenticate, (req, res, next) => ezraController.visualGraph(req, res, next));
ezraRouter.post("/rule", authMiddleware.authenticate, (req, res, next) => ezraController.createRuleFromPrompt(req, res, next));
exports.default = ezraRouter;
