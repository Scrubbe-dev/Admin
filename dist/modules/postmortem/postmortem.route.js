...
const postmortem_controller_1 = require("./postmortem.controller");
const postmortemRouter = (0, express_1.Router)();
/**
 * @swagger
 * components:
 *   schemas:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
postmortemRouter.get('/postmortems', (req, res) => postmortem_controller_1.PostmortemController.getPostmortems(req, res));
exports.default = postmortemRouter;
